...
const tmpPass=async ()=>{
    ...
    bcrypt.hash("12345",10).then(async (pass)=>{
        let user={id:1234,email:"admin",password:pass,firstName:"Giwrgos"}
        let actualUser={id:6123,email:"user1@gmail.com",password:pass,firstName:"Spiros"}
        let actualUser2={id:6124,email:"user2@gmail.com",password:pass,firstName:"Dimitris"}
        let actualUser3={id:6125,email:"user3@gmail.com",password:pass,firstName:"Panos"}
        user.type="admin"
        actualUser.type="user"
        actualUser2.type="user"
        actualUser3.type="user"
        
        let user1=new User(user);
        let user2=new User(actualUser);
        let user3=new User(actualUser2);
        let user4=new User(actualUser3);
        await user1.save();
        await user2.save();
        await user3.save();
        await user4.save();
